...
const INITIAL_SPEAKERS: Speaker[] = [
  ...
  { id: 'tom', name: 'Tom Reilly', org: 'EXETER', role: 'Professor', img: 'https://ui-avatars.com/api/?name=Tom+Reilly&background=003366&color=fff&size=256' },
  ...
  // TAs
  { id: 'ta1', name: 'Nishat', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Nishat&background=64748b&color=fff&size=256' },
  { id: 'ta2', name: 'Ashutosh', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Ashutosh&background=64748b&color=fff&size=256' },
  { id: 'ta3', name: 'Divya', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Divya&background=64748b&color=fff&size=256' },
  { id: 'ta4', name: 'Rahul', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Rahul&background=64748b&color=fff&size=256' },
  { id: 'ta5', name: 'Srishti', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Srishti&background=64748b&color=fff&size=256' },
  { id: 'ta6', name: 'Mansi', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Mansi&background=64748b&color=fff&size=256' },
  { id: 'ta7', name: 'Ashmika', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Ashmika&background=64748b&color=fff&size=256' },
  { id: 'ta8', name: 'Manas', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Manas&background=64748b&color=fff&size=256' },
  { id: 'ta9', name: 'Deenanshu', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Deenanshu&background=64748b&color=fff&size=256' },
  { id: 'ta10', name: 'Shivam', org: 'IIT DELHI', role: 'Technical Assistant', img: 'https://ui-avatars.com/api/?name=Shivam&background=64748b&color=fff&size=256' },
];
